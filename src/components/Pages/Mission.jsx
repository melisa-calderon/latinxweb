...
import graph from "./imgs/earning-by-edu.png"
const Mission = () => {
    return (
        <div>
            <Navbar />
            <div className="spacing-pg">
                ...
                <p>
                    The overall goal of this website is to provide pregnant teens
                     and/or their guardians with the necessary resources for teen 
                     mothers to continue their education. Teenage parents face numerous responsibilities that can hinder their ability to continue their education. Studies show that “Overall, 53 percent of young women who gave birth as teens received a high school diploma, compared with 90 percent of those who did not.” (Lantos and Manlove 2020). These statistics are significant because education plays a vital role in improving the quality of life for both the parents and their child. Education is a social determinant of health and has a strong correlation with economic prosperity. Therefore, ensuring that pregnant teenagers have the opportunity to continue and finish their education is essential in their success.
                </p>
                <p>
                    Education is not a federal right, so education programs vary by state and local level. This website will focus on Texas and New York, but the website identifies rights for all pregnant individuals at the federal level.
                </p>
                <p>
                ...
                <img src={graph} width="100%" alt="graph"></img>
                <p>
